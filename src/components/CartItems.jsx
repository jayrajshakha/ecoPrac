      ...
      <div className="flex items-center w-full min-h-[150px] gap-x-4">
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex justify-between mb-2">
            <Link
              className="uppercase text-xs font-semibold text-primary hover:underline max-w-[240px]"
              to={`/products/${id}`}
            >
              {title}
            </Link>
          ...
          <div className=" h-[36px] text-sm flex gap-x-2 ">
            ...
            <div className="flex-1 flex justify-around items-center font-medium text-primary ">
              {" "}
              {`$ ${price}`}
            </div>
